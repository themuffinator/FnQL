...
class QLServicesSourceTests(unittest.TestCase):
    ...
    def test_retail_connect_response_preserves_retail_and_fnql_shapes(self) -> None:
        ...
        self.assertIn("ChallengeRequestMode::RetailWithoutSteam", client)
        self.assertIn("SelectHandshakeProtocol", client)
        self.assertNotIn("Protocol 91 server is not an FnQL host", client)
