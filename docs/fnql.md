...
<li><b>\com_affinityMask</b> - bind FnQL process to bitmask-specified CPU core(s)</li>
...
What you need to do:
<ul>
<li>copy <b>q3url_add.cmd</b>/<b>q3url_rem.cmd</b> in fnql.exe directory </li>
<li>run <b>q3url_add.cmd</b> if you want to add protocol binding or <b>q3url_add.cmd</b> if you want to remove it</li>
<li>type in your browser <a href="q3a://127.0.0.1"><b>q3a://</b>127.0.0.1</a> and follow it - if you see fnql launching and trying to connect then everything is fine
</li>
</ul>
<br>
<hr>
...
In order to use this functionality you need to install ffmpeg package (on linux) or put ffmpeg binary near fnql executable (on windows).<br>
<br>
