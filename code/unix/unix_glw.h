...
{
	return fnql::posix::LoadLibraryFallback( preferred, fallback );
}

using GLW_ScopedLibrary = fnql::posix::ScopedLibrary;
...
{
	return fnql::posix::LoadSymbols( library, symbols, libraryName, fnql::posix::SymbolLoadFailure::Library );
}
#endif
