...
// Retail Quake Live native DLL import slab recovered from the host import table.
// Service-backed rows stay explicit so the engine can expose the ABI without
// silently inventing online or advertisement behavior.
typedef enum {
	...
	CG_QL_IMPORT_R_TRANSFORM_MODEL_TO_CLIP = 120,
	CG_QL_IMPORT_R_TRANSFORM_CLIP_TO_WINDOW = 121,
