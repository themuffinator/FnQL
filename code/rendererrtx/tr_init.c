...
#include "../renderercommon/tr_ql_lighting_config.h"
...
static void R_Register( void )
{
	...
	ri.Cvar_SetDescription( r_lightmap, "Lightmap debugging: 1 shows only lightmaps; 2 also color-codes their intensity." );
