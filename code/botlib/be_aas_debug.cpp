...
static constexpr int MAX_DEBUGLINES = 1024;
static constexpr int MAX_DEBUGPOLYGONS = 8192;
...
void AAS_ShowReachableAreas(int areanum)
{
	...
	{
		reach = aasworld.reachability[settings->firstreachablearea + index];
		index++;
		lasttime = AAS_Time();
...
void AAS_FloodAreas(vec3_t origin)
{
	...
	done = botlib::ClearedAlloc<int>(aasworld.numareas);
