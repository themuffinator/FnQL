...
static constexpr int AAS_MAX_PORTALS = 65536;
static constexpr int AAS_MAX_PORTALINDEXSIZE = 65536;
static constexpr int AAS_MAX_CLUSTERS = 65536;
//
static constexpr int MAX_PORTALAREAS = 1024;
...
void AAS_InitClustering(void)
{
	...
	aasworld.portals = botlib::ClearedAlloc<aas_portal_t>(AAS_MAX_PORTALS);
	//initialize portal index memory
	if (aasworld.portalindex) FreeMemory(aasworld.portalindex);
	aasworld.portalindex = botlib::ClearedAlloc<aas_portalindex_t>(AAS_MAX_PORTALINDEXSIZE);
	//initialize cluster memory
	if (aasworld.clusters) FreeMemory(aasworld.clusters);
	aasworld.clusters = botlib::ClearedAlloc<aas_cluster_t>(AAS_MAX_CLUSTERS);
	//
