...
[[maybe_unused]] static constexpr float BBOX_NORMAL_EPSILON = 0.001f;

static constexpr float ON_EPSILON = 0.0f; //0.0005

static constexpr float TRACEPLANE_EPSILON = 0.125f;
...
void AAS_InitAASLinkHeap(void)
{
	...
	if (!aasworld.linkheap)
	{
		...
		aasworld.linkheap = botlib::HunkAlloc<aas_link_t>(max_aaslinks);
	} //end if
...
void AAS_InitAASLinkedEntities(void)
{
	...
	aasworld.arealinkedentities = botlib::ClearedHunkAlloc<aas_link_t *>(aasworld.numareas);
...
//			VectorSubtract(end, start, v1);
		...
		// Axial fast paths are unsafe because node planes need not face the
		// positive axis.  Always evaluate the general plane equation.
...
// Changes Globals:		-
//===========================================================================
static void AAS_OrthogonalToVectors(const vec3_t v1, const vec3_t v2, vec3_t res)
{
