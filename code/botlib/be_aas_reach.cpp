...
static constexpr int AAS_MAX_REACHABILITYSIZE = 65536;
//number of areas reachability is calculated for each frame
[[maybe_unused]] static constexpr int REACHABILITYAREASPERCYCLE = 15;
//number of units reachability points are placed inside the areas
static constexpr int INSIDEUNITS = 2;
static constexpr int INSIDEUNITS_WALKEND = 5;
static constexpr float INSIDEUNITS_WALKSTART = 0.1f;
static constexpr int INSIDEUNITS_WATERJUMP = 15;
//area flag used for weapon jumping
static constexpr int AREA_WEAPONJUMP = 8192; //valid area to weapon jump to
...
static void AAS_SetupReachabilityHeap(void)
{
	...
	reachabilityheap = botlib::ClearedAlloc<aas_lreachability_t>(AAS_MAX_REACHABILITYSIZE);
...
static void AAS_StoreReachability(void)
{
	...
	aasworld.reachability = botlib::ClearedAlloc<aas_reachability_t>(numlreachabilities + 10);
...
void AAS_InitReachability(void)
{
	...
	areareachability = botlib::ClearedAlloc<aas_lreachability_t *>(aasworld.numareas);
	//
