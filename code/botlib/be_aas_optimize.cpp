...
{
	optimized->vertexes = botlib::ClearedAlloc<aas_vertex_t>(aasworld.numvertexes);
	optimized->numvertexes = 0;
	optimized->edges = botlib::ClearedAlloc<aas_edge_t>(aasworld.numedges);
	optimized->numedges = 1; //edge zero is a dummy
	optimized->edgeindex = botlib::ClearedAlloc<aas_edgeindex_t>(aasworld.edgeindexsize);
	optimized->edgeindexsize = 0;
	optimized->faces = botlib::ClearedAlloc<aas_face_t>(aasworld.numfaces);
	optimized->numfaces = 1; //face zero is a dummy
	optimized->faceindex = botlib::ClearedAlloc<aas_faceindex_t>(aasworld.faceindexsize);
	optimized->faceindexsize = 0;
	optimized->areas = botlib::ClearedAlloc<aas_area_t>(aasworld.numareas);
	optimized->numareas = aasworld.numareas;
	//
	optimized->vertexoptimizeindex = botlib::ClearedAlloc<int>(aasworld.numvertexes);
	optimized->edgeoptimizeindex = botlib::ClearedAlloc<int>(aasworld.numedges);
	optimized->faceoptimizeindex = botlib::ClearedAlloc<int>(aasworld.numfaces);
