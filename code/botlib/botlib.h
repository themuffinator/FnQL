...
using bot_entitystate_t = bot_entitystate_s;
...
using botlib_import_t = botlib_import_s;
...
using aas_export_t = aas_export_s;
...
using botlib_export_t = botlib_export_s;
