...
static constexpr int MAX_USERMOVE = 400;
[[maybe_unused]] static constexpr int MAX_COMMANDARGUMENTS = 10;
...
int EA_Setup(void)
{
	...
	botinputs = botlib::ClearedHunkAlloc<bot_input_t>(botlibglobals.maxclients);
