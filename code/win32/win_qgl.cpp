...
void *GL_GetProcAddress( const char *name )
{
	...
	{
		ptr = reinterpret_cast<void *>( qwglGetProcAddress( name ) );
	}
...
#define GLE( ret, name, ... ) q##name = reinterpret_cast<decltype( q##name )>( GL_GetProcAddress( XSTRING( name ) ) ); if ( !q##name ) { Com_Printf( "Error resolving core Win32 functions\n" ); return qfalse; }
	QGL_Win32_PROCS;
#undef GLE
