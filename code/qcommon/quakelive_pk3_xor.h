#ifndef QUAKELIVE_PK3_XOR_H
#define QUAKELIVE_PK3_XOR_H

/*
===========================================================================

Quake Live BETA PK3 XOR table derived from Luigi Auriemma's qldec
(`quakelivedec.c`) implementation.

===========================================================================
*/

static const char fs_quakeLivePk3Xor[] =
...
#define FS_QUAKELIVE_PK3_XOR_LEN ( (int)( sizeof( fs_quakeLivePk3Xor ) - 1 ) )
